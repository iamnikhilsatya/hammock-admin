...
import imageresponse from "../images/imagebackgroud.jpg";
  ...
  return (
    <div className="settingsIt">
      <div className="row" id="profilephoto">
        <div className="col-5" id="imageset">
        ...
        <div className="col-6">
          ...
          <i class=" fa fa-envelope col-2 pt-1"></i>
            <h6>Johndoe@site.com</h6>
          </div>
          <div className="row">
            <i className="fas fa-globe col-2 pt-1"></i>
          ...
          <div className="row">
            ...
            <div className="col-4">
              <i className="fa fa-pencil iconpadding"></i>
              <h6 className="inlineinname">Edit</h6>
            </div>
          </div>
        </div>
      </div>
      <Link to="/transactions" className="row" id="settingsBackground">
        <div className="col-3">
          <i className="fa fa-user-circle fa-3x colorIt backgroundIt"></i>
        </div>
        <div className="col-6">
      ...
      <Link to="/addpayment" className="row" id="settingsBackground">
        <div className="col-3">
          <i className="fa fa-calculator fa-3x colorIt backgroundIt"></i>
        </div>
        <div className="col-6">
      ...
      <Link to="/passwords" className="row" id="settingsBackground">
        <div className="col-3">
          <i
            class="fa fa-envelope-o  fa-3x colorIt backgroundIt"
            aria-hidden="true"
          ></i>
        </div>
        <div className="col-6">
      ...
      <Link to="/login" className="row" id="settingsBackground">
